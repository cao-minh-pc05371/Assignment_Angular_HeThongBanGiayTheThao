  ...
  products = [
    {
      ...
      image:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQlrsEd96yuOwXUmHH7Aps6CzY69qCmXGnDxw&s',
      price: 1000000,
    },
    {
      productId: 2,
    ...
    },
    {
      ...
      image:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTkRPU7NANgivcef3l-TwfyL7Vkhr5kF3w30g&s',
      price: 1100000,
    },
    {
      productId: 6,
    ...
    {
      productId: 7,
      name: 'Giày Nike Zoom Pegasus 38',
      image:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQhxwvrpj7otPNoeBJkvpBDCPX8tPu0AoBtFg&s',
      price: 1400000,
    },
    {
      productId: 8,
      name: 'Giày Reebok Classic',
      image:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT_9TvfP9P0HdC0y3m62sVJVJ2bCpx-6Uz0IA&s',
      price: 1350000,
    },
    {
      productId: 9,
      name: 'Giày Nike Air Zoom Winflo 8',
      image:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSdAXZNBmAj3F-3MeLT7BB3TyaKSGOThFbrOA&s',
      price: 1250000,
    },
    {
      productId: 10,
...
@Component({
  selector: 'app-product-detail',
  imports: [CommonModule, MatChipsModule, MatButtonModule, MatCardModule, MatRadioModule, MatButtonToggleModule],
  templateUrl: './product-detail.component.html',
  styleUrl: './product-detail.component.scss'
})
export class ProductDetailComponent {
